				...
				"content" =>
					...
					'<div data-tab="internal" class="active">
						...
						<div style="text-align:left;padding:15px;"> 
							<div><input type="radio" name="prompts" value="Disney" checked="true" id="Disney"/><label for="Disney">Disney</label></div>
							<div><input type="radio" name="prompts" value="Marvel" id="Marvel"/><label for="Marvel">Marvel</label></div>
							<div><input type="radio" name="prompts" value="Barbie" id="Barbie"/><label for="Barbie">Barbie</label></div>
						
							<div style="margin-top: 15px;">
								<label>
									Brief Prompts
								</label>
								<textarea name="briefPrompts" style="width:100%;height: 100px"></textarea>
							</div>
						</div>
