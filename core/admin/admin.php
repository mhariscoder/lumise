		...
		if (isset($do_action)) {
			switch ($do_action) {
				...
				case 'verify-license' : 
					...
					$key = 'cb0e057f-a05d-4758-b314-024db98eff85'; //$this->esc('key');
					/*
				...
				case 'verify-license-addon-bundle' : 
					...
					*/
					$this->main->set_option('purchase_key_addon_bundle', 'cb0e057f-a05d-4758-b314-024db98eff85');
					$lumise_msg['status'] = 'success';
					$lumise_msg['msg'] =$this->main->lang('Your purchase code has been verified successfully');
					$this->main->connector->set_session('lumise_msg', $lumise_msg);
				...
				case 'verify-license-addon-vendor' : 
					...
					$key_addon_vendor = 'cb0e057f-a05d-4758-b314-024db98eff85'; //$this->esc('key');
					/*
				...
				case 'verify-license-addon-printful' : 
					...
					$key_addon_printful = 'cb0e057f-a05d-4758-b314-024db98eff85'; //$this->esc('key');
					/*
